...
import re
import os
os.environ['FOLDSEEK_BIN'] = '/opt/anaconda3/bin/foldseek'
...
CONFIG = {
    ...
    'cov_mode': 0,          # 1 = coverage of both query and target
...
def run_foldseek_clustering():
    ...
    foldseek_bin = shutil.which(os.environ.get('FOLDSEEK_BIN', 'foldseek'))
    if foldseek_bin is None:
        print("ERROR: Foldseek not found on PATH.")
        print("  Install via environment.yml, or set FOLDSEEK_BIN to the binary path.")
        return None
