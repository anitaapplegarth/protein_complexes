...
R = 0.072          # node radius in axes coords
RS = 0.058         # smaller radius for the hb-graph copies
...
for k, c in (("P1", C_P1), ("P2", C_P2), ("P3", C_P3), ("P4", C_P4)):
    node(ax2, *PX[k], c, k)
ax2.text(0.10, 0.82, "$e_1$", fontsize=14, color=DASH, ha="center", va="center")
ax2.text(0.90, 0.68, "$e_2$", fontsize=14, color=DASH, ha="center", va="center")
...
ax3.add_patch(Ellipse((0.66, 0.51), 0.66, 0.84, facecolor="none",
                      edgecolor=DASH, ls=(0, (4, 3)), lw=1.0, clip_on=False))
ax3.text(0.04, 0.86, "$e_1$", fontsize=14, color=DASH, ha="center", va="center")
ax3.text(0.94, 0.84, "$e_2$", fontsize=14, color=DASH, ha="center", va="center")
