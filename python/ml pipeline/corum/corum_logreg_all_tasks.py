"""
=======================================================================
LOGISTIC REGRESSION BASELINE — REPRESENTATION COMPARISON (CORUM)
=======================================================================
...
USAGE
    Set DATA_DIR and BASE_OUTPUT_DIR below, then:  python lr_corum_all_tasks.py
...
CONFIG = {
    ...
    "BASE_OUTPUT_DIR": Path("./logistic/corum_second_testA"),
    ...
    # CORUM: stoichiometry coverage is ~4% of incidences (10.5% of proteins),
    # so the flag is close to constant. Left ON for symmetry with CP; the
    # loader prints a near-degeneracy warning.
