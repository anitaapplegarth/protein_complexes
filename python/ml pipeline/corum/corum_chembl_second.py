...
CONFIG = {
    ...
    "BASE_OUTPUT_DIR": Path("./randomforest/corum_chembl_second_testA"),
    ...
    #     "SPLITS_FILE":     "chembl_protein_splits_unstrat.csv",
    #     "BASE_OUTPUT_DIR": Path("./randomforest/corum_chembl_second_testA_unstrat"),
