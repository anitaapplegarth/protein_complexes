...
TASKS = {
    "essentiality": dict(
        summary_file=Path("./model_sweep/corum_ess/sweep_summary.csv"),
        task_label="Gene essentiality",
        prevalence=0.224,
    ),
    "chembl": dict(
        summary_file=Path("./model_sweep/corum_chembl/sweep_summary.csv"),
        task_label="Drug-target status (ChEMBL)",
        prevalence=0.060,
    ),
    "hpa": dict(
        summary_file=Path("./model_sweep/corum_hpa/sweep_summary.csv"),
