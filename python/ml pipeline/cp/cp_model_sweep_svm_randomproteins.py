...
TASKS = {
    "ess": dict(
        SPLITS_FILE="ess_protein_splits_randomprotein.csv",
        LABEL_MAP={'Essential': 1, 'Non-essential': 0},
        OUTPUT_DIR=Path("./model_sweep/cp_ess/randomprotein"),
    ),
    "hpa": dict(
        SPLITS_FILE="hpa_protein_splits_randomprotein.csv",
        LABEL_MAP={'Drug_target': 1, 'Non_target': 0},
        OUTPUT_DIR=Path("./model_sweep/cp_hpa/randomprotein"),
    ),
    "chembl": dict(
        SPLITS_FILE="chembl_protein_splits_randomprotein.csv",
        LABEL_MAP={'Drug_target': 1, 'Non_target': 0},
        OUTPUT_DIR=Path("./model_sweep/cp_chembl/randomprotein"),
    ),
}
...
CONFIG = {
    ...
    "RESULTS_CSV":      "sweep_results_svm_randomprotein.csv",       # long format, appended
    "PREDICTIONS_CSV":  "predictions_svm_randomprotein.csv",         # per-protein scores, appended
