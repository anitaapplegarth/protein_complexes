...
CONFIG = {
    ...
    "BASE_OUTPUT_DIR": Path("./randomforest/cp_hpa_second_testA_randprot"),
    ...
    #     "BASE_OUTPUT_DIR": Path("./randomforest/cp_hpa_second_testA_unstrat"),
    # Changing only one silently overwrites the other arm's results.
    "SPLITS_FILE":           "hpa_protein_splits_randprot.csv",
