...
CONFIG = {
    "RESULTS_CSV": Path("./cp_chembl/randomprotein/sweep_results_randomprotein.csv"),
    "OUTPUT_DIR":  Path("./cp_chembl/randomprotein"),
    "TASK_LABEL":  "CP — Drug Target Status (CP_CHEMBL)",
}
