...
cp_chembl_analyse_model_sweep.py for the task named in TASK_LABEL.
=======================================================================
"""
...
CONFIG = {
    ...
    "OUTPUT_A":   Path("./cp_chembl/fig_chembl_ladder_A_ordering.png"),
    "OUTPUT_B":   Path("./cp_chembl/fig_chembl_ladder_B_effects.png"),
    "SHOW_TOTAL": True,
    "TASK_LABEL": "CP \u2014 drug target(CP_CHEMBL)",
...
def panel_b(ax, df):
    ...
    spec = [
        ('H1',    +0.24, 'o', '#6ec6e8', 'H1: hypergraph \u2212 pairwise'),
        ('H2',     0.00, 'o', '#8ccf7e', 'H2: hb-graph \u2212 hypergraph'),
    ]
    if CONFIG["SHOW_TOTAL"]:
        spec.append(
            ('total', -0.24, 'D', '#5b2c6f', 'Total: hb-graph \u2212 pairwise'))
