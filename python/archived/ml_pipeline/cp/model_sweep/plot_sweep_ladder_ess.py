...
cp_ess_analyse_model_sweep.py for the task named in TASK_LABEL.
=======================================================================
"""
...
CONFIG = {
    ...
    "OUTPUT_A":   Path("./cp_ess/fig_ess_ladder_A_ordering.png"),
    "OUTPUT_B":   Path("./cp_ess/fig_ess_ladder_B_effects.png"),
    "SHOW_TOTAL": True,
    "TASK_LABEL": "CP \u2014 gene essentiality (CP_ESS)",
