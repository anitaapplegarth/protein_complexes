...
CONFIG = {
    ...
    "BASE_OUTPUT_DIR": Path("./depmap/randomforest/cp_one_hop_stoich_merged"),

    # --- File Names ---
    "SPLITS_FILE":           "depmap/cp_ess_merged_splits.csv",
    "PROTEIN_FEATURES_FILE": "cp_hypergraph_features.csv",
    "PAIRWISE_FEATURES_FILE":"cp_pairwise_features.csv",
