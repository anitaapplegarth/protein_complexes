...
CONFIG = {
    'task_description': 'Drug target Labels (HPA) — PROTEIN-LEVEL RANDOM',
    ...
    'output_all_splits': f'{BASE}/cp/hpa_protein_splits_randomprotein.csv',
    'output_balance':    f'{BASE}/cp/hpa_split_balance_randomprotein.csv',
    ...
    'max_label_rate_deviation': 1.5,   # pp lower than essentiality, 1.5pp is a reasonable tolerance for HPA
    'max_attempts':             25,
