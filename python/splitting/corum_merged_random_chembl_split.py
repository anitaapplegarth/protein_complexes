...
The analysis population is proteins that are BOTH:
  - labelled (Drug_target or Non_target in corum_drug_target_chembl.csv)
...
OUTPUTS
-------
  corum_drug_chembl_protein_splits.csv       : one row per (protein, split_index)
  corum_drug_chembl_split.csv                : per-split label balance statistics
  corum_drug_chembl_split_summary.txt        : human-readable summary + profile
...
CONFIG = {
    ...
    'drug_target':        '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/corum_drug_target_chembl.csv',

    # Output files
    'output_all_splits':    '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/corum/chembl_protein_merged_splits.csv',
    'output_balance':       '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/corum/chembl_merged_groups.csv',
    'output_summary':       '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/corum/chembl_split_merged_summary.txt',
    'output_drug_by_size':  '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/corum/avg_chembl_by_group__merged_size.csv',
