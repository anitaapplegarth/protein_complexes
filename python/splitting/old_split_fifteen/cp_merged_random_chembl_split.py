...
The analysis population is proteins that are BOTH:
  - labelled (Drug_target or Non_target in cp_drug_target_chembl.csv)
  - structured (present in cp_mapping_struct.csv, i.e. have a group_id)
...
OUTPUTS
-------
  cp_drug_chembl_protein_splits.csv       : one row per (protein, split_index)
  cp_drug_chembl_split.csv                : per-split label balance statistics
  cp_drug_chembl_split_summary.txt        : human-readable summary + profile
  cp_avg_drug_target_by_group_size.csv : drug target rate per group size
...
CONFIG = {
    ...
    'drug_target':        '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/cp_drug_target_chembl.csv',

    # Output files
    'output_all_splits':    '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/cp/chembl_protein_merged_splits.csv',
    'output_balance':       '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/cp/chembl_merged_groups.csv',
    'output_summary':       '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/cp/chembl_split_merged_summary.txt',
    'output_drug_by_size':  '/Users/anitaapplegarth/github/dphil/protein_complexes/data/lookup_tables/cp/avg_chembl_by_group__merged_size.csv',
...
def main():
    ...
    print("Drug Target Labels (ChEMBL)")
    print("=" * 70)
    ...
    lines.append("Drug Target Labels (ChEMBL)")
    lines.append("=" * 90)
