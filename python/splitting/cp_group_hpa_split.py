...
CONFIG = {
    ...
    # ---- Output files ------------------------------------------------------
    'output_all_splits':   f'{BASE}/cp/hpa_protein_splits.csv',
    'output_balance':      f'{BASE}/cp/hpa_split_balance.csv',
    'output_summary':      f'{BASE}/cp/hpa_split_summary.txt',
    'output_rate_by_size': f'{BASE}/cp/avg_hpa_by_group_size.csv',
